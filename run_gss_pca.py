...
def parse_args():
    ...
    # Data files
    parser.add_argument('--public-topics', type=str, default='public_issues.csv',
                        help='CSV file with public issues topics')
    parser.add_argument('--public-polarization', type=str, default='public_issues_polarization.csv',
                        help='CSV file with public issues polarization data')
    parser.add_argument('--private-topics', type=str, default='private_life.csv',
                        help='CSV file with private life topics')
    parser.add_argument('--private-polarization', type=str, default='private_life_polarization.csv',
