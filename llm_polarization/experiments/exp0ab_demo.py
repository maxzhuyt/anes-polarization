"""
Experiment 0A/0B Extended — Demographic Simulation Version

Same 10 model variants as exp0ab_extended.py (politician), but uses GSS respondent
...
Usage:
    python exp0ab_demo.py --group 1   # gemma-2-9b (base + instruct)
    python exp0ab_demo.py --group 2   # Llama-3.1-8B (base + instruct)
    python exp0ab_demo.py --group 3   # Qwen3-4B (base + instruct + reasoning)
    python exp0ab_demo.py --group 4   # SmolLM3-3B (base + instruct + reasoning)
"""
